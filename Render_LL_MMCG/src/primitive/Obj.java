...
//La classe primitive.Obj funge da "padre" delle varie geometrie
//presenti nel programma (primitive.Triangle e primitive.Sphere); grazie a
...
/* Il problema principale è l'erronea gestione degli oggetti
 *  da questa classe. Programmata inizialmente secondo
 *  un'ottica di programmazione strutturata, sarebbe l'ideale
 *  creare una superclasse per gli oggetti, con i metodi principali
 *  da richiamare, per poi estendere le classi alle sottoclassi
 *  dell'oggetto in questione. Altrimenti la gestione dalle
 *  varie classi richiederà sempre un controllo preventivo
 *  dell'oggetto.
 */
